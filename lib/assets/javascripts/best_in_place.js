...
function BestInPlaceEditor(e) {
  var click_action = 'doubletap dblclick';
  this.element = e;
  this.initOptions();
  this.bindForm();
  this.initNil();
  ...
  jQuery(this.activator).bind(click_action, {editor: this}, this.clickHandler);
}
...
BestInPlaceEditor.prototype = {
  ...
  activate : function() {
    ...
    jQuery(this.activator).unbind('doubletap dblclick', this.clickHandler);
    this.activateForm();
  ...
  abort : function() {
    ...
    jQuery(this.activator).bind('doubletap dblclick', {editor: this}, this.clickHandler);
